...
const shifts_repository_1 = require("../shifts/shifts.repository"); // Reutilizamos para traer zonas
const uuid_1 = require("../../utils/uuid");
class AttendanceService {
    constructor() {
        this.repository = new attendance_repository_1.AttendanceRepository();
        this.shiftRepository = new shifts_repository_1.ShiftRepository();
    }
    async registerMarking(companyId, identification, lat, lng) {
            ...
            for (const zone of zones) {
                ...
                if (distance <= zone.radius) {
                    ...
                    if (schedule?.marking_zone_id) {
                        if (schedule.marking_zone_id === zone.id)
                            isValidZone = true;
                    }
                    else {
